...
Agent sẽ quét Google AI Search, Google Trends và web để tìm các chủ đề đang tăng trưởng theo khoảng thời gian 24h, 7 ngày hoặc 30 ngày gần đây.
...
Agent sẽ kiểm tra chéo tín hiệu trên **Google Trends** (độ ổn định, spike, related queries), **Etsy** (engagement score, số listing, mức giá, fav/view rate). Kết quả là một bảng so sánh với điểm tổng hợp cho từng niche.
...
**Báo cáo toàn diện:**
> Nghiên cứu toàn diện niche "comfort colors shirt": khám phá, xác minh tín hiệu trên Google Trends + Etsy, lấy top sản phẩm và viết báo cáo đầy đủ.
